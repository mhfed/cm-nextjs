        ...
        <div className="grid grid-cols-5 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><Link href="/">Về Coolmate</Link></li>
              <li><Link href="/">Cơ hội việc làm</Link></li>
              <li><Link href="/">Blog</Link></li>
              <li><Link href="/">Chăm sóc khách hàng</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>Hotline: <Link href="tel:1900272737">1900.27.27.37</Link></li>
              <li>Email: <Link href="mailto:Cool@coolmate.me">Cool@coolmate.me</Link></li>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Image src="/momo.svg" alt="Momo" width={40} height={24} />
              <Image src="/zalopay.svg" alt="ZaloPay" width={40} height={24} />
            </div>
          </div>
        </div>
      </Container>
