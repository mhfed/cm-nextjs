// Lý do sử dụng Embla Carousel:
// - Tối ưu hiệu năng, Bundle size rất nhỏ, không làm nặng ứng dụng
// - Responsive, Có thể tùy chỉnh UI theo design system
// - Dễ dàng custom, Tối ưu cho product gallery với nhiều hình ảnh
    ...
    return (
      ...
      >
        <div
          ...
          className={cn(
            'relative grid h-full w-full gap-2 focus:outline-none',
            className
          )}
          dir={direction}
        >
